...
try: # incase any err, hdf5 NEED to be closed
# region 2) imports
...
#     y,x=0,0
    ...
    for grp in ims_to_use:
        for imN in ims_to_use[grp]:
            ...
            # TODO: map_img not exporting to tensorboard with new res values
...
# region X) close hdf5 files
    ...
    for f in files.values():
        name = str(f.key())
        f.close()
        print('[bold white on green]' + name + ' has OFFICIALLY been closed')
