...
from geo_deep_learning.utils.models import swinmae_load_weights_from_checkpoint
from models.pretrain.swin_mae import SwinMAEPretrainModel
...
class PretrainSwinMAE(LightningModule):
    ...
    def __init__(  # noqa: PLR0913
        ...
        *,
        ...
        qk_scale: float | None = None,  # kept for config compatibility
        ape: bool = False,  # kept for config compatibility
        use_checkpoint: bool = False,  # kept for config compatibility
        max_samples: int = 10,
    ...
    def configure_model(self) -> None:
        """Configure model."""
        self.model = SwinMAEPretrainModel(
        ...
        if self.weights_from_checkpoint_path:
            ...
            swinmae_load_weights_from_checkpoint(
                self.model,
                self.weights_from_checkpoint_path,
