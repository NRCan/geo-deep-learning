...
from models.utils import ConvModule, PPM
...
if __name__ == "__main__":
    upernet = UperNetDecoder(embed_dim=[256, 512, 1024, 2048], 
                             pool_scales=(1, 2, 3, 6), 
                             channels=256, align_corners=False, scale_modules=False)
    
    x = [torch.randn(5, 256, 16, 16), torch.randn(5, 512, 8, 8), torch.randn(5, 1024, 4, 4), torch.randn(5, 2048, 2, 2)]
    out = upernet(x)
    print(out.shape)
