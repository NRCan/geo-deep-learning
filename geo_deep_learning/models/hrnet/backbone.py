...
BatchNorm2d = ModelHelpers.batchnorm2d()
BN_MOMENTUM = 0.1
...
def hrnetv2(num_of_classes, pretrained=False, **kwargs):
    model = HRNetV2(n_class=num_of_classes, **kwargs)
    if pretrained:
...
if __name__ == "__main__":
    ...
    model = hrnetv2(num_of_classes=4, pretrained=True)
    batch_size = 8
