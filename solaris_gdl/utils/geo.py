...
def reproject(input_object, input_crs=None,
    ...
    vice versa, use :func:`solaris_gdl.vector.polygon.georegister_px_df` or
    :func:`solaris_gdl.vector.polygon.geojson_to_px_gdf` instead.
...
def get_crs(obj):
    ...
    if isinstance(obj, gpd.GeoDataFrame):
        ...
        raise TypeError("solaris_gdl doesn't know how to extract a crs from an "
