...
class Evaluator():
    ...
    def __init__(self, ground_truth_vector_file):
        ...
        try:
            if ground_truth_vector_file.lower().endswith('json') or ground_truth_vector_file.lower().endswith('gpkg'):
    ...
    def load_proposal(self, proposal_vector_file, conf_field_list=['conf'],
        ...
        if os.path.isfile(proposal_vector_file):
            ...
            if proposalCSV:
                ...
                try:
                    # Read data
                    collection = list(fiona.open(proposal_vector_file, 'r'))
                    ...
                    self.proposal_GDF = gpd.GeoDataFrame.from_features(collection)
